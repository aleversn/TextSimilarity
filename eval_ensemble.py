...
myData_eval = EnsembleEvalSimWithLabelDataset(tokenizer, './dataset/std_data', 50)
...
EVAL_EPOCH_BERT = 916
model_dict = torch.load("./model/bert_sim/bert_sim_{}.pth".format(EVAL_EPOCH_BERT)).module.state_dict()
...
# %%
eval_ensemble(esim, model, eval_list, myData_eval, 0, 0)
